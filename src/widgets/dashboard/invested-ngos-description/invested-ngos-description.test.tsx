...
import { NgoCarouselDescription } from './invested-ngos-description.component'
...
describe('<NgoCarouselDescription/>', () => {
  test('Renders correctly', () => {
    const component = render(<NgoCarouselDescription data={mock}/>)
